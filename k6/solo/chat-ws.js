...
import {CHAT_URL, CHAT_WS_URL, JWT_SECRET, STUDENT_ID_MIN, TEACHER_ID_MIN} from '../config.js';
import {authHeader, generateToken} from '../helpers/jwt.js';
import {JSON_HEADERS, randomUUID} from '../helpers/utils.js';
