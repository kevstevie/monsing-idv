/**
 * GET /my-lessons — 내 수업 목록 스트레스 테스트 (Student Auth)
 * 실행: k6 run --out influxdb=http://localhost:8086/k6 k6/stress/solo/my-lessons.js
 */
...
export default function () {
  ...
  const res   = http.get(
    `${BASE_URL}/my-lessons`,
    { headers: authHeader(token), tags: { name: 'GET /my-lessons' } }
  );
...
export const handleSummary = makeSummaryHandler('GET /my-lessons 스트레스 테스트 (max 1000 VU)');
