/**
 * GET /courses?teacherId={id} — 강의 목록 스트레스 테스트
 * 실행: k6 run --out influxdb=http://localhost:8086/k6 k6/stress/solo/courses.js
 */
...
export const handleSummary = makeSummaryHandler('GET /courses 스트레스 테스트 (max 1000 VU)');
