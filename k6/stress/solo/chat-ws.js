...
const MSG_COUNT  = 10;   // student VU당 전송 메시지 수
...
export const handleSummary = makeSummaryHandler('WebSocket 채팅 스트레스 테스트 (max 500 VU × 2 시나리오)');
